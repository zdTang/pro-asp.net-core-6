...
public class GuidResponseFilterFactoryAttribute:Attribute,IAsyncAlwaysRunResultFilter,IFilterFactory
{
        ...
        {
            return ActivatorUtilities.GetServiceOrCreateInstance<GuidResponseFilterFactoryAttribute>(serviceProvider);
        }
